...
export default function Header() {
  return (
    <header className="flex flex-wrap bg-gray-700 text-white opacity-80 fixed w-full z-50 top-0 left-0 h-[50px] select-none">
      <a href="/" className="flex">
        <img
          src="/logo.png"
          alt="Logo"
          className="h-[50px] ml-5 rounded hidden sm:flex"
        />
        <h1
          className="text-3xl p-1.5 ml-3 font-extrabold rounded-md"
          style={{
            textDecoration:
        ...
        >
          ...
          <span className="text-blue-500 hidden sm:inline">Network</span>
        </h1>
      </a>
